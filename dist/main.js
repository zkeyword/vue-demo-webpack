...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    components: {
	        'vnSwiper': __webpack_require__(32)
	    }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <template>
	//     <time-conf :timer.sync="timer"></time-conf>
	//    {{timer}}
	// </template>
	//
	// <script>
	exports.default = {
	    ...
	    ready: function ready() {
	        ...
	        //self.timer = '21-31-34354353543543'
	    },
	
	    components: {
	        'timeConf': __webpack_require__(40)
	    }
	};
	// </script>
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        'headerBar': __webpack_require__(57)
	    }
	};
	// </script>
	/* generated by vue-loader */
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"page-user\">\n    <header-bar :title=\"title\"></header-bar>\n    \n    <div class=\"content inside showPadding\">\n        <a external v-link=\"\">edit</a>\n\n\n        <div class=\"card-header\">\n            <img src=\"xxxHTMLLINKxxx0.7339352245908230.8062813046853989xxx\">\n            名字\n\n            未认证，点此认证！\n            \n            好评   1\n            中评\n            差评   1\n            收藏\n        </div>\n\n        <div class=\"list-block\">\n            <ul>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">我的余额</div>\n                    </div>\n                </li>\n            </ul>\n        </div>\n        <div class=\"list-block\">\n            <ul>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">设置</div>\n                    </div>\n                </li>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">发布服务</div>\n                    </div>\n                </li>\n            </ul>\n        </div>\n        <div class=\"list-block\">\n            <ul>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">发单任务</div>\n                    </div>\n                </li>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">接单任务</div>\n                    </div>\n                </li>\n            </ul>\n        </div>\n        <div class=\"list-block\">\n            <ul>\n                <li class=\"item-content item-link\">\n                    <div class=\"item-media\"><i class=\"icon icon-f7\"></i></div>\n                    <div class=\"item-inner\">\n                        <div class=\"item-title\">在线客服</div>\n                    </div>\n                </li>\n            </ul>\n        </div>\n        <router-view></router-view>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         }
	//         .icon-anquanbaozhang{
	//             background:url(../../../img/anquanbaozhang.svg) no-repeat;
	//             .rem(background-size, 32, 32);
	//             .rem(height, 32);
	//             .rem(width, 32);
	//         }
	//         .icon-anquanbaozhang2{
	//             background:url(../../../img/anquanbaozhang2.svg) no-repeat;
	//             .rem(background-size, 32, 32);
	//         }
	//     }
	// </style>
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    components: {
	        'timeConf': __webpack_require__(40),
	        'sceneType': __webpack_require__(100),
	        'headerBar': __webpack_require__(57)
	    },
	    methods: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    components: {
	        'vnFooter': __webpack_require__(120),
	        'vnHeader': __webpack_require__(57)
	    }
	};
	// </script>
